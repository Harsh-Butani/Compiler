...
void printMenu(){
	...
	printf("12: Count unassigned variables in while loop\n");
	printf("-------------------------------------\n");
...
void countUnassignedVariablesInWhileLoop(char* sourceFile, char* outputFile){
...
int main(int argc, char* argv[]){
	...
	while(true){
		...
		switch(choice){
			...
			case 12: 
			    if(semanticAnalysisDone){
			    	countUnassignedVariablesInWhileLoop(sourceFile, outputFile);
				}
				else{
					printf("press 9 and run semantic analyzer\n");
				}
