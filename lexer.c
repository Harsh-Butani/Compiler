...
void generateLookupTable(){
    ...
    insertTable(lookup_table, "printoffset", TK_PRINTOFFSET);
    insertTable(lookup_table, "switch", TK_SWITCH);
    insertTable(lookup_table, "case", TK_CASE);
    insertTable(lookup_table, "break", TK_BREAK);
    insertTable(lookup_table, "endswitch", TK_ENDSWITCH);
    insertTable(lookup_table, "default", TK_DEFAULT);
}
